/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2b63b0045510ae6304e19cefbcc69f5a)
// Runtime types generated with workerd@1.20260107.1 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "Project" | "Hub" | "Sandbox";
	}
	interface Env {
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_API_TOKEN: string;
		CLOUDFLARE_GATEWAY_ID: string;
		Project: DurableObjectNamespace<import("./worker/index").Project>;
		Hub: DurableObjectNamespace<import("./worker/index").Hub>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_GATEWAY_ID">> {}
}
